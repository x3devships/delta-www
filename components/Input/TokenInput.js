...
const TokenInput = ({
    ...
    const renderHelpers = () => {
        return (
            <>
                <HelperText className={`${validAmount ? "hidden" : ""} text-sm block`} valid={false}>
    ...
    const renderMaxButton = () => {
        return (
            <div className="p-1 border border-black ml-1">
                    ...
                    <div className="flex flex-row">
                        <div className="flex flex">
                            ...
                            <div className={`ml-1 hidden ${!transactionButtonUnder ? "md:flex" : ""}`}>
                                ...
                                {checkboxButton && (
                                    <div className="flex md:p-1 ml-1 md:border md:border-black flex-grow">
