...
const ApyDisplay = () => {
  ...
  return <DeltaSection title="(D / W / Y) APY For Ethereum & Usdt">
    <DeltaPanel>
      ...
      <div className="text-center mt-2 md:mt-4 text-lg"> Weekly Apy --- Delta: ${totalApy.apy.eth_weeklyy_delta}, LSW: ${totalApy.apy.eth_weeklyy_rlp_lsw}, Mint: ${totalApy.apy.eth_weeklyy_rlp_mint}, Uni: ${totalApy.apy.eth_weeklyy_rlp_uni} </div>
