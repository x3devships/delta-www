      ...
      <DeltaPanel className="md:mt-0">
        <div className="md:mt-0">
          ...
          <DeltaPanel className="mt-8 text-lg block">
            ...
            Delta's open vested liquidity is used for deriavative trading on CoreDEX - The DEX beeing build by the core team. <a target="_blank" href="https://medium.com/core-vault/announcing-coredex-318dfc42a67b">Go <u>here</u> to read more about the CoreDEX</a>.
            </div>
          </DeltaPanel>
          ...
          <DeltaPanel className="mt-8 text-lg block">
            ...
            <div style={answerStyle}>
              You can mint rLP but mint rLP becomes more expensive as time passes after launch of the protocol. RLP can likely be swapped cheaper on SushiSwap/Uniswap but trading of rLP is not supported by community and not the Delta team.
            </div>
          </DeltaPanel>
          ...
          <DeltaPanel className="mt-8 text-lg block">
            ...
            <div style={answerStyle}>
            The LSW phase of the project is over and mint has to be minted or bought from other users who has participated in the LSW. The DELTA team does not support or facilitate trading of rLP tokens.
            </div>
          </DeltaPanel>
