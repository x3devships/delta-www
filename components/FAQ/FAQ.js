...
<div className="block md:flex">
          ...
          <DeltaPanel className="mt-8 text-lg block">
            ...
            <div style={answerStyle}>
              Delta has a vesting mechanism built into its token that is triggered on transfer. This Open Vesting Liquidity is useful for onchain options and will be utilized by the upcoming coreDEX. You can read more regarding coreDEX here.</div>
          </DeltaPanel>

          <DeltaPanel className="mt-8 text-lg block">
            <DeltaTitleH4>Why have my DELTA or Ethereum rewards not changed for some time?</DeltaTitleH4>
            <div style={answerStyle}>
              The yield derives from vesting schedule interruptions. If there are no interruptions, no rewards are being paid out. The team is
