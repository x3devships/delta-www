...
const LimitedWindow = ({ text, image, url }) => {
    ...
    return (
        <div className="flex w-80">
            <button onClick={gourl} className="bg-black shadow-xl hover:bg-gray-800 p-4 mt-4 inline-block text-white uppercase flex ml-2" style={{ marginRight: "1px" }}>
            ...
            <button onClick={gourl} className="border-black hover:bg-gray-100 border bg-transparent p-4 mt-4 inline-block text-white flex ml-2" style={{ marginRight: "1px" }}>
